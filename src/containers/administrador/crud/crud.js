...
import { FormControl, Grid, TextField, Paper } from '@material-ui/core'
...
export const CrudContainer = props => {
	...
	return (
		<Fragment >
			<Paper className={`${classes.ajuste}`}>
										...
										<Grid item xs={12}>
											<FormControl variant="outlined" className={`${classes.margin}, ${classes.textField}`}>
												<ComboCustom
													...
													onChange={(event, value) => onChangeCombo(event, value, column.value)}
